...
def calculate_indicators(prices_history, minutes_to_evaluate=15, hours_for_trend=4):
    """
...
def calculate_variation_and_trend(prices_history, minutes_to_evaluate=15, hours_for_trend=4):
    current_time = datetime.now()
    variations = {}
    ...
    while True:
        ...
        if data:
            ...
            indicators = calculate_indicators(
                prices_history, minutes_to_evaluate=15, hours_for_trend=4
            )

            variations = calculate_variation_and_trend(prices_history, minutes_to_evaluate=15, hours_for_trend=4)
            ...
            for pair, pair_indicators in indicators.items():
                ...
                # Conditions for sale sign
                    ...
                    (rsi_evaluation > 90 and variation < -4)
